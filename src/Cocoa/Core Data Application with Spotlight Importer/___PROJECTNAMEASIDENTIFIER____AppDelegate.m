//
//  ___PROJECTNAMEASIDENTIFIER____AppDelegate.m
//  ___PROJECTNAME___
//
...
#import "___PROJECTNAMEASIDENTIFIER____AppDelegate.h"

#define YOUR_EXTERNAL_RECORD_EXTENSION @"xxxx"
#define YOUR_STORE_TYPE NSXMLStoreType

@implementation ___PROJECTNAMEASIDENTIFIER____AppDelegate

@synthesize window;

/**
    Returns the support directory for the application, used to store the Core Data
    store file.  This code uses a directory named "___PROJECTNAMEASIDENTIFIER___" for
...
- (NSString *)applicationSupportDirectory {
    ...
    return [basePath stringByAppendingPathComponent:@"___PROJECTNAMEASIDENTIFIER___"];
}

/**
    Returns the external records directory for the application.
	This code uses a directory named "___PROJECTNAMEASIDENTIFIER___" for the content, 
...
- (NSString *)externalRecordsDirectory {
    ...
    NSString *basePath = ([paths count] > 0) ? [paths objectAtIndex:0] : NSTemporaryDirectory();
    return [basePath stringByAppendingPathComponent:@"Metadata/CoreData/___PROJECTNAMEASIDENTIFIER___"];
}
